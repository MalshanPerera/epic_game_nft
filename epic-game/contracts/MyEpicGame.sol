...
contract MyEpicGame is ERC721 {
  ...
  function tokenURI(uint256 _tokenId) public view override returns (string memory) {
    ...
    string memory strDefence = Strings.toString(charAttributes.defense);
      ...
      bytes(
        string(
          abi.encodePacked(
            ...
            strAttackDamage,'}, { "trait_type": "Defence", "value": ', strDefence,'}, { "trait_type": "Crit Chance", "value": ', strCritChance,'} ]}'
          )
        )
      )
    );
  ...
  function attackBoss() public {
    ...
    if (bigBoss.hp < player.attackDamage) {
      ...
      bigBoss.hp = bigBoss.hp - (player.attackDamage + (player.critChance *  5 / 10));
    }
    ...
    if (player.hp < bigBoss.attackDamage) {
      ...
      player.hp = (player.hp + player.defense) - bigBoss.attackDamage;
    }
